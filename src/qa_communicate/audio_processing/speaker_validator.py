...
class SpeakerValidator:
    ...
    def __init__(self):
        ...
        self.sales_strong_patterns = [
            re.compile(p, re.IGNORECASE) for p in self.SALES_STRONG_INDICATORS
        ]
        self.sales_weak_patterns = [
            re.compile(p, re.IGNORECASE) for p in self.SALES_WEAK_INDICATORS
        ]
        self.customer_strong_patterns = [
            re.compile(p, re.IGNORECASE) for p in self.CUSTOMER_STRONG_INDICATORS
        ]
        self.customer_weak_patterns = [
            re.compile(p, re.IGNORECASE) for p in self.CUSTOMER_WEAK_INDICATORS
        ]
