...
class QASalesEvaluator:
    def __init__(
        ...
        self.sale_script_db = create_csvdatabase(csv_path=csv_path, db_path=db_path)
    ...
    def rebuild_database(self, csv_path: str, db_path: str):
        self.sale_script_db = create_csvdatabase(
            csv_path=csv_path, db_path=db_path, force_rebuild=True
        )
    ...
    async def run_evaluate(
        self, audio_bytes: bytes, task_id: int, trace=None, parent_span=None
    ):
        """
